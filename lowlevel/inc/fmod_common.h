...
#define FMOD_VERSION    0x00010214
...
typedef struct FMOD_CREATESOUNDEXINFO
{
    ...
    FMOD_FILE_OPEN_CALLBACK        useropen;           /* [w] Optional. Specify 0 to ignore. Callback for opening this file. */
    FMOD_FILE_CLOSE_CALLBACK       userclose;          /* [w] Optional. Specify 0 to ignore. Callback for closing this file. */
    FMOD_FILE_READ_CALLBACK        userread;           /* [w] Optional. Specify 0 to ignore. Callback for reading from this file. */
    FMOD_FILE_SEEK_CALLBACK        userseek;           /* [w] Optional. Specify 0 to ignore. Callback for seeking within this file. */
    FMOD_FILE_ASYNCREAD_CALLBACK   userasyncread;      /* [w] Optional. Specify 0 to ignore. Callback for seeking within this file. */
    FMOD_FILE_ASYNCCANCEL_CALLBACK userasynccancel;    /* [w] Optional. Specify 0 to ignore. Callback for seeking within this file. */
